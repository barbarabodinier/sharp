...
In a regression context, stability selection is done using LASSO regression as implemented in the R package [**glmnet**](https://cran.r-project.org/web/packages/glmnet/index.html). 
...
In a graphical modelling context, stability selection is done using the graphical LASSO as implemented in the R package [**glassoFast**](https://cran.r-project.org/web/packages/glassoFast/index.html). 
