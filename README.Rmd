...
To illustrate the use of the main functions implemented in [**sharp**](https://github.com/barbarabodinier/sharp), three artificial datasets are created:
...
Stability selection and consensus clustering can theoretically be done by aggregating the results from any selection (or clustering) algorithm on subsamples of the data. The choice of the underlying algorithm to use is specified in argument `implementation` in the main functions. Consensus clustering using partitioning around medoids, K means or Gaussian mixture models are also supported in [**sharp**](https://github.com/barbarabodinier/sharp):
